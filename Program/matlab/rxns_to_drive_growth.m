...
% save the table
result_table = table(vertcat(ab_info_1{:}),vertcat(ab_info_2{:}),vertcat(ab_info_3{:}),vertcat(ab_info_4{:}),vertcat(ab_info_5{:}), ...
...
result_table.Properties.VariableNames = {'Ab_info_1','Ab_info_2','Ab_info_3','Ab_info_4','Ab_info_5', ...
