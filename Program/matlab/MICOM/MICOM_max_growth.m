function solution = MICOM_max_growth(model, abTable)
% Function for finding the maximum community growth rate.
% Input:
...
for i = 1:numel(num)
    ...
    f(bio) = -1 * abTable.relative_ab(find(contains(abTable.Genome,['KG',num{i},'_genomic'])));
