...
cons <- read.table(paste0(topDir, 'consensus_variability_analysis_with_opt_lambda.csv'),
                   header = T, sep = ',')
...
carv <- read.table(paste0(topDir, 'carveme_variability_analysis_with_opt_lambda.csv'),
                   header = T, sep = ',')
...
gaps <- read.table(paste0(topDir, 'gapseq_variability_analysis_with_opt_lambda.csv'),
                   header = T, sep = ',')
...
kbas <- read.table(paste0(topDir, 'kbase_variability_analysis_with_opt_lambda.csv'),
                   header = T, sep = ',')
